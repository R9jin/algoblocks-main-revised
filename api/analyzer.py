...
This module composes those pieces into the ComplexityAnalyzer class via
mixin inheritance and exposes the top-level analyze/fallback functions.
"""
import ast
import re
import time
...
from call_graph_mapper import CallGraphMapperMixin
from topological_sequencer import TopologicalSequencerMixin
from complexity_heuristics import ComplexityHeuristicsMixin
from signature_recorder import SignatureRecorderMixin
from ast_node_visitors import ASTNodeVisitorsMixin
from complexity_synthesizer import ComplexitySynthesizerMixin
...
class ComplexityAnalyzer(
    CallGraphMapperMixin,
    TopologicalSequencerMixin,
    ComplexityHeuristicsMixin,
    SignatureRecorderMixin,
    ASTNodeVisitorsMixin,
    ComplexitySynthesizerMixin,
    ast.NodeVisitor,
):
    RECURRENCE_RESOLVER = {
        "T(n) = n * T(n-1)": "O(n!)", 
...
def analyze_source_code(source_code):
    ...
    try:
        ...
        analyzer.visit_functions_topologically()
