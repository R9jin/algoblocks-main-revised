...
const pastelTheme = Blockly.Theme.defineTheme("pastelTheme", {
  ...
  blockStyles: {
    logic_blocks: {
      colourPrimary: "#c1a0e8",
      colourSecondary: "#B8A0D6",
      colourTertiary: "#A38CC1",
    },
    loop_blocks: {
      colourPrimary: "#8bcf8b",
      colourSecondary: "#90BC90",
      colourTertiary: "#7CA77C",
    },
    math_blocks: {
      colourPrimary: "#4C97FF",
      colourSecondary: "#2c80f5",
      colourTertiary: "#2A70CC",
    },
    text_blocks: {
      colourPrimary: "#d5a52a",
      colourSecondary: "#E5AF2C",
      colourTertiary: "#CC9A26",
    },
    io_blocks: {
      colourPrimary: "#FF8A65",
      colourSecondary: "#E27A59",
      colourTertiary: "#C76B4E",
    },
    list_blocks: {
      colourPrimary: "#4DB6AC",
      colourSecondary: "#42A097",
      colourTertiary: "#388C83",
    },
    dict_blocks: {
      colourPrimary: "#BA68C8",
      colourSecondary: "#A65CB4",
      colourTertiary: "#9251A0",
    },
    set_tuple_blocks: {
      colourPrimary: "#7986CB",
      colourSecondary: "#6B77B5",
      colourTertiary: "#5E68A0",
    },
    stack_queue_blocks: {
      colourPrimary: "#F06292",
      colourSecondary: "#D75883",
      colourTertiary: "#BD4D73",
    },
    variable_blocks: {
      colourPrimary: "#f38286",
      colourSecondary: "#DB888B",
      colourTertiary: "#C27679",
    },
    procedure_blocks: {
      colourPrimary: "#7a6b66",
      colourSecondary: "#BDB2AE",
      colourTertiary: "#A89D9A",
    },
    raw_blocks: {
...
const customBlocks = [
  ...
  },
  {
    ...
    colour: "#d5a52a",
    tooltip:
      "Joins a list of strings into one string using a specified delimiter",
  },
  {
    type: "string_to_list",
  ...
  },
  {
    ...
    colour: "#4C97FF",
    tooltip:
      "Performs advanced math operations such as Floor Division, Power, Bitwise Shifts, and Bitwise Logic",
  },
  {
    type: "type_cast_int",
    message0: "int %1",
  ...
  },
  {
    ...
    style: "dict_blocks",
    tooltip:
      "Removes the specified key or index and returns the corresponding value.",
  },
  {
  ...
  },
  {
    ...
    style: "set_tuple_blocks",
    tooltip:
      "Converts a list into a set, removing duplicates and enabling O(1) lookups",
  },
  {
    type: "set_add",
  ...
  },
  {
    ...
    style: "set_tuple_blocks",
    tooltip:
      "Performs mathematical set operations (union, intersection, difference).",
  },
  {
    type: "tuple_create",
  ...
  },
  {
    ...
    style: "io_blocks",
    tooltip:
      "Displays a message and waits for the user to type something in the console.",
  },
  {
    type: "python_type",
    message0: "type of %1",
  ...
  },
  {
    ...
    style: "list_blocks",
    tooltip:
      "Python list slicing. Leave inputs blank to default to the beginning or end of the list.",
  },
  {
    type: "list_concat",
  ...
  },
  {
    ...
    colour: "#d5a52a",
    tooltip:
      "Converts text to uppercase, lowercase, title case, or capitalized.",
  },
  {
    type: "stack_push",
    ...
    tooltip:
      "Pushes an item onto the top of the stack (equivalent to list.append).",
  },
  {
    type: "stack_pop",
    ...
    style: "stack_queue_blocks",
    tooltip:
      "Pops the top item off the stack and returns it (equivalent to list.pop()).",
  },
  {
  ...
  },
  {
    ...
    style: "stack_queue_blocks",
    tooltip:
      "Adds an item to the back of the queue (equivalent to list.append).",
  },
  {
    type: "queue_dequeue",
    ...
    style: "stack_queue_blocks",
    tooltip:
      "Removes and returns the front item of the queue (equivalent to list.pop(0)).",
  },
  {
    ...
    },
    {
      ...
      contents: [
        ...
        { kind: "block", type: "text_newline" },
        {
          ...
          type: "text_multiply",
          inputs: {
            MULTIPLIER: { shadow: { type: "math_number", fields: { NUM: 2 } } },
          },
        },
    ...
    },
    {
      ...
      contents: [
        { kind: "block", type: "text_print" },
        {
          ...
          inputs: {
            PROMPT: {
              shadow: { type: "text", fields: { TEXT: "Enter your name: " } },
            },
          },
        },
      ],
...
const BlocklyWorkspace = forwardRef(({ onChange, syntaxError }, ref) => {
  ...
  useImperativeHandle(ref, () => ({
    ...
    loadTemplate: (json, preservePythonCode = undefined) => {
      if (workspace.current) {
        ...
        setTimeout(() => {
          ...
          const currentJson = Blockly.serialization.workspaces.save(
            workspace.current,
          );
          ...
          if (preservePythonCode !== undefined && preservePythonCode !== null) {
            const isUnsynced =
              preservePythonCode.trim() !== code.trim() &&
              preservePythonCode !== "# Drag blocks to generate Python code";
            if (onChangeRef.current)
              onChangeRef.current(currentJson, preservePythonCode, isUnsynced);
          } else {
            if (onChangeRef.current)
              onChangeRef.current(currentJson, code, false);
          }
        }, 100);
      }
    },
    ...
    setTheme: (themeName) => {
      if (workspace.current) {
        workspace.current.setTheme(
          themeName === "dark" ? DarkTheme : pastelTheme,
        );
      }
    },
      ...
      try {
        ...
        setTimeout(() => {
          if (workspace.current) {
            ...
            if (onChangeRef.current)
              onChangeRef.current(currentJson, pythonCode);
          }
        }, 100);
        // ----------------------------------------------------------
      } catch (error) {
  ...
  useEffect(() => {
    ...
    if (blocklyDiv.current) {
      ...
      pythonGenerator.forBlock["math_assignment"] = function (block) {
        const variable = pythonGenerator.getVariableName(
      ...
      pythonGenerator.forBlock["controls_for"] = function (block) {
        ...
        if (step.trim() === "1")
          rangeCode =
            from.trim() === "0" ? `range(${to})` : `range(${from}, ${to})`;
      ...
      pythonGenerator.forBlock["math_min_max"] = function (block) {
        ...
        const a =
          pythonGenerator.valueToCode(block, "A", pythonGenerator.ORDER_NONE) ||
          "0";
        const b =
          pythonGenerator.valueToCode(block, "B", pythonGenerator.ORDER_NONE) ||
          "0";
      ...
      pythonGenerator.forBlock["text_join"] = function (block) {
        ...
        for (let i = 0; i < itemCount; i++) {
          let elementCode = pythonGenerator.valueToCode(
            block,
            "ADD" + i,
            pythonGenerator.ORDER_NONE,
          );
      ...
      pythonGenerator.forBlock["dict_from_pairs"] = function (block) {
        ...
        for (let i = 0; i < listBlock.itemCount_; i++) {
          let pairCode = pythonGenerator.valueToCode(
            listBlock,
            "ADD" + i,
            pythonGenerator.ORDER_NONE,
          );
      ...
      pythonGenerator.forBlock["variable_swap"] = function (block) {
        const var1 = pythonGenerator.getVariableName(
          block.getFieldValue("VAR1"),
        );
        const var2 = pythonGenerator.getVariableName(
