...
The ast.NodeVisitor visit_* implementations that collect raw structural
pattern signals (recursion calls, comparisons, comprehensions, etc.)
while walking a function body, for later evaluation into higher-level
signals (recursion/memoization/backtracking/graph-context).
"""
import ast
import random
import re
...
class PatternVisitMixin:
    """Mixin providing ast.NodeVisitor visit_* methods to ComprehensiveASTVisitor."""
